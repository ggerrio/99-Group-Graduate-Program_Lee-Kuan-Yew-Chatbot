...
class FaithfulnessEvaluator:
    ...
    def evaluate_faithfulness(self, query: str, context: str, answer: str) -> Dict[str, Any]:
        ...
        prompt = (
            ...
            "4 = Well supported, minor stylistic paraphrase\n"
            "3 = Partially supported, some unverified general claims\n"
            "2 = Mostly unsupported or invented specific claims\n"
            "1 = Contradicts context or completely hallucinated\n\n"
            "Output format:\n"
            "SCORE: <number 1-5>\n"
            "UNSUPPORTED_CLAIM: <claim if score < 3, else None>\n"
